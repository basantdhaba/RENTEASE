...
export default function PropertyDetails({ propertyId }: PropertyDetailsProps) {
  ...
  useEffect(() => {
    const fetchProperty = () => {
      ...
      let foundProperty = demoProperties.find((p) => p.id === Number.parseInt(propertyId as string))
      ...
      if (!foundProperty) {
        ...
        foundProperty = approvedProperties.find((p) => p.id === Number.parseInt(propertyId as string))
      }

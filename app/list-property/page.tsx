...
export default function ListPropertyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const whatsAppMessage = `Thank you for listing your property "${propertyDetails.address}". Your listing has been successfully submitted and is pending review.`
    await sendWhatsAppMessage(propertyDetails.ownerWhatsApp, whatsAppMessage)
